...
<p className="max-w-3xl mx-auto text-lg text-white leading-relaxed font-black mb-8 drop-shadow-[0_3px_3px_rgba(0,0,0,0.8)]">
            نحول رؤيتك إلى واقع بأيدي خبراء. تشطيبات متكاملة، دهانات حديثة،
            وديكورات فخمة تضفي طابعاً ملكياً على مساحتك. نضمن لك أعلى معايير
            الجودة والتزاماً صارماً بموعد التسليم.
          </p>
        ...
        <section className="px-5 max-w-6xl mx-auto -mt-24">
          <div className="rounded-[35px] overflow-hidden h-[350px] bg-black/20 backdrop-blur-sm shadow-2xl border border-white/20">
            <video
              autoPlay
              muted
              loop
...
{/* 🖼️ قسم الصورة */}
              <div className="flex-1 min-w-[300px] relative min-h-[400px] group overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-end justify-center p-8 opacity-0 group-hover:opacity-100 transition-opacity">
                  <div className="bg-white/10 backdrop-blur-md border border-amber-400/40 text-amber-300 px-6 py-3 rounded-2xl font-bold shadow-2xl">
