      ...
      <div className="relative z-10">
        ...
        <section className="px-5 max-w-6xl mx-auto mt-20">
          {SECTIONS.map((section) => (
            <article
              key={section.id}
              className="flex flex-wrap items-stretch rounded-[40px] overflow-hidden mb-16 bg-white/10 backdrop-blur-xl border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.35)] transition-all duration-300 hover:bg-white/15 hover:border-amber-400/50"
            >
              {/* النص */}
              <div className="flex-1 min-w-[300px] p-8 md:p-12 flex flex-col justify-center">
                ...
                <p className="text-white/90 text-base leading-loose font-medium mb-6">
                  {section.desc}
                </p>
                <ul className="space-y-3 mb-10">
                  {section.features.map((feature, i) => (
                    <li key={i} className="flex items-start text-amber-50 font-semibold">
                ...
                <a
                  href={section.link}
                  className="inline-block bg-gradient-to-r from-amber-500 to-yellow-600 text-white px-8 py-4 rounded-full font-black shadow-lg hover:brightness-110 transition-all w-fit"
                >
                  الدخول لمعرض القسم ←
                </a>
              </div>
              ...
              <div className="flex-1 min-w-[300px] relative min-h-[400px] group overflow-hidden">
                ...
                />
                <div className="absolute inset-0 flex items-end justify-center p-8 opacity-0 group-hover:opacity-100 transition-opacity bg-black/20 backdrop-blur-[2px]">
                  <div className="bg-white/10 backdrop-blur-md border border-white/20 text-white px-6 py-3 rounded-2xl font-bold shadow-2xl">
          ...
          {/* كرت التقييم */}
          <div className="bg-white/10 backdrop-blur-xl p-12 rounded-[40px] text-center border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.35)]">
