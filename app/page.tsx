...
const SECTIONS = [
  ...
  },
  {
    ...
    features: [
      ...
      "مقاومة للتشققات وتغير الألوان (ضمان 10 سنوات)",
      "استخدام دهانات جوتن وعسيب الأصلية"
    ],
  ...
  },
  {
    ...
    features: [
      "معالجة الشروخ والتشققات العميقة",
      "القضاء على الرطوبة وتقشر الدهان القديم",
      "صنفرة وتأسيس بمعجون عالي الصلابة"
    ],
    link: "/wall-repair",
    imgNum: 3
  },
  {
    ...
    features: [
      "تنسيق الألوان لتعطي إيحاءً باتساع المكان",
      "حماية كاملة للأرضيات والأبواب أثناء العمل",
      "باقات أسعار تنافسية للعرسان"
    ],
  ...
  },
  {
    ...
    features: [
      "تنفيذ ديكورات الفوم وبديل الرخام والخشب",
      "تذهيب وتعتيق بطابع كلاسيكي أو نيو-كلاسيك",
      "إشراف هندسي على دقة التشطيبات"
    ],
    link: "/flats-paints",
    imgNum: 5
  },
  {
    ...
    features: [
      "دهانات شديدة التحمل للاحتكاك والاستهلاك",
      "إمكانية العمل بنظام الورديات الليلية لعدم التعطيل",
      "ألوان مدروسة هندسياً لزيادة الإنتاجية"
    ],
  ...
  },
  {
    ...
    features: [
      "استخدام غراء إيطالي أصلي مضاد للفطريات",
      "تركيب جميع الأنواع (ورقي، فينيل، مخملي)",
      "تجهيز الجدار مسبقاً لضمان الثبات التام"
    ],
  ...
  },
  {
    ...
    features: [
      "مناظر 3D ثلاثية الأبعاد تعطي عمقاً للمكان",
      "نقشات هندسية ونباتية حديثة",
      "خامات قابلة للمسح والتنظيف بسهولة"
    ],
  ...
  },
  {
    ...
    features: [
      "مطابقة الألوان مع لون الأثاث والأرضيات",
      "اختيار نوع الدهان المناسب لاستخدام كل غرفة",
      "زيارة ميدانية لرفع المقاسات وتقديم العينات"
    ],
  ...
  },
  {
    ...
    features: [
      "صور حقيقية 100% من مواقع العمل",
      "مقارنات (قبل وبعد) لتوضيح حجم الإنجاز",
      "تغطية لأحياء شمال الرياض (العارض، الملقا، النرجس)"
    ],
    link: "/latest-works",
    imgNum: 10
  }
        ...
        <div className="relative z-10">
          ...
          <header className="relative min-h-[550px] flex flex-col items-center justify-center text-center px-5 pt-20 pb-40 rounded-b-[50px] border-b border-white/10 bg-gradient-to-b from-black/80 via-black/40 to-transparent">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-4 leading-tight drop-shadow-[0_5px_5px_rgba(0,0,0,0.8)]">
              مـعلم دهانات <br />
              <span className="text-brand-gold bg-gradient-to-r from-amber-400 to-yellow-500 bg-clip-text text-transparent">
                وديكورات الرياض
              </span>
            </h1>

            <p className="max-w-3xl mx-auto text-lg text-white leading-relaxed font-black mb-8 drop-shadow-[0_3px_3px_rgba(0,0,0,0.8)]">
              نحول رؤيتك إلى واقع بأيدي خبراء. تشطيبات متكاملة، دهانات حديثة، وديكورات فخمة تضفي طابعاً ملكياً على مساحتك.
            </p>

            <div className="flex flex-col items-center">
              <p className="text-white text-base mb-2 font-bold drop-shadow-md">
            ...
            {SECTIONS.map((section) => (
              <article
                ...
                className="
                  ...
                  rounded-[40px] overflow-hidden mb-16
              ...
              >
                ...
                <div className="flex-1 min-w-[300px] p-8 md:p-12 flex flex-col justify-center">
                  ...
                  <ul className="space-y-3 mb-10">
                    {section.features.map((feature, i) => (
                      <li
                        key={i}
                        className="flex items-start text-amber-50 font-semibold drop-shadow-sm"
                      >
                  ...
                  <a
                    href={section.link}
                    className="
                      inline-block bg-gradient-to-r from-amber-500 to-yellow-600
                      text-white px-8 py-4 rounded-full font-black shadow-lg
                      hover:brightness-110 transition-all w-fit
                    "
                  >
                    الدخول لمعرض القسم ←
                  </a>
                ...
                <div className="flex-1 min-w-[300px] relative min-h-[400px] group overflow-hidden">
                  ...
                  {/* overlay خفيف فقط */}
                  <div className="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-center p-8">
                    <div className="bg-black/70 backdrop-blur-md border border-amber-400/30 text-amber-400 px-6 py-3 rounded-2xl font-bold shadow-2xl">
                      👆 اضغط لفتح {section.title}
                    </div>
                  </div>
...
{/* ⭐️ كرت التقييم */}
            <div className="
              bg-white/5 backdrop-blur-md
              p-12 rounded-[40px] text-center
              shadow-2xl border border-white/10
            ">
              <div className="text-amber-400 text-4xl mb-4">★★★★★</div>

              <p className="text-xl font-black text-white leading-relaxed italic drop-shadow-sm">
                "شغل احترافي، دقة في المواعيد، ونتيجة فاخرة جداً."
              </p>

              <p className="text-amber-200 font-bold mt-6 drop-shadow-sm">
                — ابو فهد (حي الملقا)
              </p>
            </div>
          </section>
